...
class AccessControlView extends React.Component {
    ...
    render() {
        ...
        if (typeof accessInfo !== 'undefined' && accessInfo.hasOwnProperty('enabled')) {
            ...
            clearanceLevel = accessInfo.ClearanceLevelID;
            let deviceID = accessInfo.DeviceID;
            getCameraInfoByDeviceId(deviceID, (cameraInfo) => {
                if(cameraInfo.AttributeNameID === 18){
                    let cameraName = cameraInfo.AttributeValue;
            ...
            <div className={'AccessControlModal DataCard bg-transparent'} style={{ display: display }}>
                <div className={'AccessContainer'}>
                    <div className={'CameraArea DataCard bg-transparent'}>
                        ...
                        <div className={'cameraLoadingArea'} id={'cameraLoadingArea'} style={{ display: loadIconShow }}>
                    ...
                    <div className={'LogHistoryArea'}>
                        ...
                        <div className={'historyTableHeader row'}>
                            <div className={'col-3'}>
                                <span className={'filterButton'} onClick={this.filterButtonClick.bind(this, 'date')}>
                            ...
                            <div className={'col-3'}>
                                <span className={'filterButton'} onClick={this.filterButtonClick.bind(this, 'time')}>
                            ...
                            <div className={'col-3'}>
                                <span className={'filterButton'} onClick={this.filterButtonClick.bind(this, 'operator')}>
                            ...
                            <div className={'col-3 last'}>
                                <span className={'filterButton'} onClick={this.filterButtonClick.bind(this, 'access')}>
