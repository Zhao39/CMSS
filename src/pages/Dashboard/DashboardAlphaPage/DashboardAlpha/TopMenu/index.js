...
class TopMenu extends React.Component {
    ...
    render() {
        ...
        let securityLevelImage = 'resources/images/icons/SVG/' + 'Security Level ' + securityLevel + '.svg';
        return (
                              ...
                              curDevices.map(device => {
                                  ...
                                  return (
                                      <li onClick={onAccessMenuClick.bind(this, accessInfo)}>
                                          <div className={className}>
                                              <p className={'cameraName'} style={{textAlign: "left", paddingLeft: "20px"}}>{"- " + device.LocationName}</p>
                                          </div>
                                      </li>
                                  )
                              })
    ...
    return (
        <ul className="dropdown">
            ...
            <li>
                ...
                >
                    <li>
                        <div className={'listItem functionItem'}>
                            {'ON'}
                        </div>
                    </li>
                    <li>
