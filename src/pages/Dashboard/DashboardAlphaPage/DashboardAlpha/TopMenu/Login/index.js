...
class LoginView extends React.Component {
    ...
    onLogin = () => {
        ...
        let data = '<UserCheckPermission><' + userName + '><' + password + '><Modify System Security Level>';
        ...
        return (
            <div className="LoginView" style={{ display: display }}>
                ...
                <div className={'fieldArea firstField'}>
                    ...
                    <div className={'inputItem'}><input type={'text'} value={userName} onChange={this.onUserNameChange.bind(this)}/></div>
                </div>
                <div className={'fieldArea'}>
                    <div className={'captionItem'}>PASSWORD</div>
                    <div className={'inputItem'}><input type={'password'} value={password} onChange={this.onPasswordChange.bind(this)}/></div>
                </div>
