    ...
    setSecurityLevel = () => {
        ...
        if(currentSecurityLevel === selectedLevel.toString()){
            ...
            if(userPermission !== "Modify System Security Level") {
                ...
                let data = "<UserChangeSecurityLevel><" + userName + "><" + password + "><" + selectedLevel + ">";
                if (!this.socketOpened) {
        ...
        return (
            <div className="SecuritySettingView" style={{display: display}}>
                ...
                <div className={'SecurityNumberArea'}>
                    <div className={selectedLevel === 1?'NumberButton first selected':'NumberButton first'} onClick={this.selectLevel.bind(this, 1)}>1</div>
                    <div className={selectedLevel === 2?'NumberButton second selected':'NumberButton second'} onClick={this.selectLevel.bind(this, 2)}>2</div>
                    <div className={selectedLevel === 3?'NumberButton third selected':'NumberButton third'} onClick={this.selectLevel.bind(this, 3)}>3</div>
                </div>
                <div className={'buttonArea'}>
                    <div className={'setButton'} onClick={this.setSecurityLevel}>CHANGE</div>
                </div>
