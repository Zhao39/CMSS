        ...
        return (
            <div className="SecuritySettingView" style={{ display: display }}>
                ...
                <div className={'SecurityNumberArea'}>
                    <div
                        className={selectedLevel === 3 ? 'NumberButton first selected' : 'NumberButton first'}
                        onClick={this.selectLevel.bind(this, 3)}
                    >
                        1
                    </div>
                    <div
                        className={selectedLevel === 4 ? 'NumberButton second selected' : 'NumberButton second'}
                        onClick={this.selectLevel.bind(this, 4)}
                    >
                        2
                    </div>
                    <div
                        className={selectedLevel === 5 ? 'NumberButton third selected' : 'NumberButton third'}
